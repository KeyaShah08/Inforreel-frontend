      ...
      <div style={{
        ...
        <section style={{ marginTop: '100vh', textAlign: 'left' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            {/* Navigation Buttons */}
            <div style={{ display: 'flex', marginBottom: '10px', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontWeight: 'bold', color: 'White', marginRight: '870px', fontSize: '20px' }}>Shop by Brands</span>
        ...
        <section style={{  textAlign: 'left', marginTop: '40px' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            {/* Navigation Buttons */}
            <div style={{ display: 'flex', marginBottom: '10px', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontWeight: 'bold', color: 'White', marginRight: '870px', fontSize: '20px' }}>Shop by Products</span>
              <div style={{ display: 'flex' }}>
                <button
                  onClick={prevProduct}
                  style={{
        ...
        <section style={{  textAlign: 'left', marginTop: '40px' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            {/* Navigation Buttons */}
            <div style={{ display: 'flex', marginBottom: '10px', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontWeight: 'bold', color: 'White', marginRight: '870px', fontSize: '20px' }}>Shop by Brand Ambassadors</span>
              <div style={{ display: 'flex' }}>
                <button
        ...
        <section style={{ textAlign: 'left', marginTop: '40px' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            {/* Navigation Buttons */}
            <div style={{ display: 'flex', marginBottom: '10px', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontWeight: 'bold', color: 'White', marginRight: '870px', fontSize: '20px' }}>Shop by Brand Videos</span>
              <div style={{ display: 'flex' }}>
                <button
                  onClick={prevVideo}
                  style={{
